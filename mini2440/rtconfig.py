...
if PLATFORM == 'gcc':
    ...
    AFLAGS = DEVICE
    # LFLAGS = DEVICE + ' --noscanlib --strict --info sizes --info totals --info unused --info veneers --list rtthread-mini2440.map --ro-base 0x30000000 --entry Entry_Point --first Entry_Point'
